...
automl_run_id = 'affable_window_d7fhg16xs5_28'
...
def generate_data_transformation_config():
    ...
    column_group_1 = ['Gender', 'Married', 'Education', 'Self_Employed', 'Property_Area_Rural', 'Property_Area_Semiurban', 'Property_Area_Urban']
    
    column_group_0 = [['Column1'], ['Dependents'], ['ApplicantIncome'], ['CoapplicantIncome'], ['LoanAmount'], ['Loan_Amount_Term'], ['Credit_History']]
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingClassifier(
        ...
        weights=[0.3333333333333333, 0.5, 0.16666666666666666]
    )
...
def main(training_dataset_uri=None):
    ...
    cv_splits = _CVSplits(X, y, frac_valid=None, CV=10, n_step=None, is_time_series=False, task='classification')
    scores = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://subscriptions/e4b55002-5402-4eb7-b4ec-feb75f3b92ac/resourcegroups/rg-bank-loan-wyu8kb/workspaces/ws-bank-loan-wyu8kb/datastores/workspaceblobstore/paths/LocalUpload/3d0fb57ffc002ae35c6e6645b35fd12b8fd322e95c2960b7153b88f62f890bdd/proc_data/',     help='Default training dataset uri is populated from the parent run')
