...
workspace_name = "ws-bank-loan-wyu8kb" # PLACEHOLDER
subscription_id = "e4b55002-5402-4eb7-b4ec-feb75f3b92ac" # PLACEHOLDER
resource_group = "rg-bank-loan-wyu8kb" # PLACEHOLDER
experiment_name = "auto-ml-bank-loan" # PLACEHOLDER
iteration = "28"  # PLACEHOLDER
run_id = "affable_window_d7fhg16xs5_28"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/auto-ml-bank-loan','subscription_id':'e4b55002-5402-4eb7-b4ec-feb75f3b92ac','resource_group':'rg-bank-loan-wyu8kb','workspace_name':'ws-bank-loan-wyu8kb','compute_target':'aml-cluster','iterations':30,'primary_metric':'accuracy','task_type':'classification','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':10,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':40,'enforce_time_on_windows':False,'experiment_timeout_minutes':120,'exit_score':'NaN','experiment_exit_score':'NaN','auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'maximize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_priority':'dedicated','label_column_name':'Loan_Status','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2,'vm_type':'Standard_E4s_v3','blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN']} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'accuracy','verbosity':20,'ensemble_iterations':15,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'compute_target':'aml-cluster','subscription_id':'e4b55002-5402-4eb7-b4ec-feb75f3b92ac','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"affable_window_d7fhg16xs5_28\",\"experiment_name\":\"auto-ml-bank-loan\",\"workspace_name\":\"ws-bank-loan-wyu8kb\",\"subscription_id\":\"e4b55002-5402-4eb7-b4ec-feb75f3b92ac\",\"resource_group_name\":\"rg-bank-loan-wyu8kb\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"/subscriptions/e4b55002-5402-4eb7-b4ec-feb75f3b92ac/resourceGroups/rg-bank-loan-wyu8kb/providers/Microsoft.MachineLearningServices/workspaces/ws-bank-loan-wyu8kb/data/bank-loan-training/versions/1\",\"ResolvedUri\":\"azureml://subscriptions/e4b55002-5402-4eb7-b4ec-feb75f3b92ac/resourcegroups/rg-bank-loan-wyu8kb/workspaces/ws-bank-loan-wyu8kb/datastores/workspaceblobstore/paths/LocalUpload/3d0fb57ffc002ae35c6e6645b35fd12b8fd322e95c2960b7153b88f62f890bdd/proc_data/\",\"AssetId\":\"azureml://locations/uksouth/workspaces/2cfc7524-2a1d-4174-8035-293b6e3ab195/data/bank-loan-training/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
