...
automl_run_id = 'cyan_curtain_q1xf29lk23_9'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://subscriptions/e4b55002-5402-4eb7-b4ec-feb75f3b92ac/resourcegroups/rg-bank-loan-isv0fa/workspaces/ws-bank-loan-isv0fa/datastores/workspaceblobstore/paths/LocalUpload/13ef1ec9f3777937cde16a02762271f93b1ff52d88adf55f4aa768a7d42992ea/proc_data/',     help='Default training dataset uri is populated from the parent run')
