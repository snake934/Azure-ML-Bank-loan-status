...
data_sample = PandasParameterType(pd.DataFrame({"Loan_ID": pd.Series(["example_value"], dtype="object"), "Gender": pd.Series(["example_value"], dtype="object"), "Married": pd.Series([False], dtype="bool"), "Dependents": pd.Series([0.0], dtype="float64"), "Education": pd.Series(["example_value"], dtype="object"), "Self_Employed": pd.Series([False], dtype="bool"), "ApplicantIncome": pd.Series([0], dtype="int64"), "CoapplicantIncome": pd.Series([0.0], dtype="float64"), "LoanAmount": pd.Series([0.0], dtype="float64"), "Loan_Amount_Term": pd.Series([0.0], dtype="float64"), "Credit_History": pd.Series([0.0], dtype="float64"), "Property_Area": pd.Series(["example_value"], dtype="object")}))
